...
\ex. 	\a. \Tree[.DP [.D the C ] \qroof{Germans}.NP ]
...
\ex. 	\Tree[.XP C [.DP [.D the ] \qroof{Germans}.NP ] ]
...
Domain restriction is independently necessary, and in section REF %TODO section ref
...
I assume, following REFS %TODO Name refs
...
\ex. 	\a.	\Tree[.DP [.D THE C ] \qroof{John}.NP ]
...
% `John' wouldn't only be a student.
% But if you introduce the domain restriction over students as well as people we know, then we're laughing.
% Note that if you make this move, you're then forbidden from asserting that John isn't a student -- you'd contradict yourself.

% Jacobson's account doesn't quite make the right predictions here.
